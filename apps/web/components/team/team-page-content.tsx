...
// Team page. Reads members + pending invites from the cache (SSR
// prefetched), and exposes invite + member-management mutations to
// admins. The `canManage` prop is set server-side based on whether the
// /api/team/invites prefetch succeeded — admins-only get the invite UI.
export function TeamPageContent({ canManage }: { canManage: boolean }) {
  ...
  return (
    <AdminPageShell activeItem="team">
      <AppTopbar
        title="Team"
