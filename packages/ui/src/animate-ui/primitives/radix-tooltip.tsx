...
// Vendored from animate-ui (https://animate-ui.com/docs/radix/tooltip).
// Wraps Radix's Tooltip primitives with motion — the visible content
// fades + scales in/out via spring instead of CSS animation classes.
// Imports rewritten from `@/...` to `@workspace/ui/...` to fit the
// monorepo's path alias (only `@workspace/ui/*` resolves in
...
import { useControlledState } from "@workspace/ui/animate-ui/hooks/use-controlled-state"
import { getStrictContext } from "@workspace/ui/animate-ui/lib/get-strict-context"
