...
} from '@workspace/ui/animate-ui/primitives/radix-alert-dialog';
import { buttonVariants } from '@workspace/ui/components/button';
import { cn } from '@workspace/ui/lib/utils';

// Width preset kept from the previous shadcn alert-dialog so existing
// `<AlertDialogContent size="sm">` callers keep working.
